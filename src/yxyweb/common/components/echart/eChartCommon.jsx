...
export function getNewColKey() {
  return keyPrefix.panelTemplateColKey + Math.floor(Math.random() * 10000000000);
}
...
export function getNewRowKey() {
  return keyPrefix.panelTemplateRowKey + Math.floor(Math.random() * 10000000000);
}
...
export function getNewChartKey() {
  return keyPrefix.panelTemplateChartKey + Math.floor(Math.random() * 10000000000);
}
...
export function upgradeConfig(config) {
  ...
  if (yySetting.type == "scatter" && !yySetting.regionInfo) {
    LogChartInfo(" upgradeConfig Before yySetting ", JSON.stringify(yySetting), 15)
    let regionInfo = {};
    ...
    if (key == 'china')  //导入的地图
    {
      ...
      if (ele) {
        ...
        LogChartInfo("upgradeConfig 没找到对应的待升级地区。yySetting ", JSON.stringify(yySetting), 999)
        return;
      }
    }
    yySetting.regionInfo = regionInfo;
    LogChartInfo(" upgradeConfig After yySetting ", JSON.stringify(yySetting), 15)
...
export function LogChartInfo(logTag, logStr, errNumber) {
  if (errNumber == 999)
    console.log("图形报表日志 异常信息 " + logTag + (logStr === "" ? "" : (" = " + logStr)));
  else if (errNumber >= 903)
    console.log("图形报表日志 " + logTag + (logStr === "" ? "" : (" = " + logStr)) + " err=" + errNumber);//
}
          ...
          eChartSetting: {
            ...
            toolbox: {
              ...
              feature: {
                ...
                saveAsImage: {
                  title: "保存为图片",
                  icon: 'image://http://ov62qgheo.bkt.clouddn.com/edf87fcc-cf46-423f-8fe8-34f77455a589.png'
...
export function getBackStyleArr(key) {
  ...
  let arr = [];
  arr.push({ backStyleKey: "backStyle_1", className: "backStyle_1", skinKey: "skinKey_1", name: "神秘黑色", backgroundImage: "http://ov62qgheo.bkt.clouddn.com/ff63cafd-8f0b-4e47-9d03-9826c3dc7614.png", icon: "http://ov62qgheo.bkt.clouddn.com/9c68f2e5-966a-4c23-9f44-92d00a9ed088.png" });
  arr.push({ backStyleKey: "backStyle_2", className: "backStyle_2", skinKey: "skinKey_1", name: "科技蓝色", backgroundImage: "http://ov62qgheo.bkt.clouddn.com/5cee4a50-87ed-49dc-86e9-f04f809c1814.png", icon: "http://ov62qgheo.bkt.clouddn.com/a473fbe3-ddeb-4809-acc9-4b79ee45c528.png" });
  if (key)
