      ...
      <Modal
        ...
        <Form className="ant-advanced-search-form">
          ...
          <Row colCount={2} gutter={24}>
            <Col span={1}>
              <FormItem label="数据类型" labelCol={{ span: 7 }} wrapperCol={{ span: 13 }} >
                {getFieldDecorator
                  ("type", { rules: [{ required: true, message: '请录入数据类型', }, { validator: this.checkType }], initialValue: "" })
            ...
            <Col span={1}> <FormItem label="项目名称" labelCol={{ span: 6 }} wrapperCol={{ span: 14 }} > {getFieldDecorator("showItem", { rules: [{ required: true, message: '请录入显示名称,最大长度为50个字符。', max: 50 }, { validator: this.checkItemName, }], })(<Input placeholder="请录入显示名称" size="default" />)} </FormItem> </Col>
          ...
          <Row colCount={2} gutter={24}>
            ...
            <Col span={1}> <FormItem label="控制录入长度" labelCol={{ span: 7 }} wrapperCol={{ span: 13 }} > {getFieldDecorator("maxInputLen", { rules: [{ required: needMaxInputLen, message: '请录入控制录入长度' }] })(<Input placeholder="请输入控制录入长度" size="default" disabled={this.state.maxInputLenDisabled} />)} </FormItem> </Col>
